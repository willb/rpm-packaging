...
java -Xms512M -Xmx1536M -Xss1M -XX:+CMSClassUnloadingEnabled -Dfedora.sbt.ivy.dir=/usr/share/java/sbt/ivy-local -Dsbt.boot.properties=${SBT_BOOT_PROPERTIES} -cp ${SBT_CLASSPATH}:${BASE_CLASSPATH} -jar /usr/share/java/sbt/sbt-launch.jar $*